...
privileged aspect BikeLetRoleController_Roo_Controller {
    ...
    public String BikeLetRoleController.create(@Valid BikeLetRole bikeLetRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, bikeLetRole);
    ...
    public String BikeLetRoleController.createForm(Model uiModel) {
        populateEditForm(uiModel, new BikeLetRole());
        return "bikeletroles/create";
    }
    ...
    public String BikeLetRoleController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String BikeLetRoleController.update(@Valid BikeLetRole bikeLetRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, bikeLetRole);
    ...
    public String BikeLetRoleController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        ...
        return "redirect:/bikeletroles";
    }
    
    void BikeLetRoleController.populateEditForm(Model uiModel, BikeLetRole bikeLetRole) {
        uiModel.addAttribute("bikeLetRole", bikeLetRole);
    }
    
    String BikeLetRoleController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
